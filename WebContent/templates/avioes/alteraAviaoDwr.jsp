...
<body>
	...
	<div class="container">
		...
		<form autocomplete="off" action="javascript:alterar(); carregaGridAvioes();">
		
			<div class="row">				
				<div class="input-field col s4">
					<i class="material-icons prefix">phone</i>
					<input placeholder="Ex: blabla" id="codAviaoAlt" type="text" class="validate">
	...
	<script type='text/javascript' src='../../js/avioes/dwr/altera.js'></script>   
